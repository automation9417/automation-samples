...
def google_sign_in(email,password):
    ...
    signup_btn=clicknium.find_element(locator.websites.slack.google_sign_in_btn)
    signup_btn.click()
    ...
    print("Click next.")
    next_btn=clicknium.find_element(locator.websites.google_account.email_or_phone_next_btn)
    next_btn.click()
    ...
    next_btn_sign_in=clicknium.find_element(locator.websites.google_account.password_next_btn)
    next_btn_sign_in.click()
